    ...
    pm2Cmd
        ...
        try {
            ...
            processes.forEach((proc) => {
                ...
                const memory = (monit.memory / 1024 / 1024).toFixed(0);
                const cpu = monit.cpu;
                const uptime = formatUptime(pm2env.pm_uptime);
                const restarts = pm2env.restart_time;
                console.log(`${proc.name.padEnd(20)} | ` +
