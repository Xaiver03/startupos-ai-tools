...
export function createPeriodCommand() {
    ...
    periodCmd
        ...
        await apiPost('/api/period-end/close', {
            workspace_id: options.workspace,
            period_id: options.period,
        }, 'Closing period...', {
            json: options.json,
            onSuccess: (data) => {
                const closedData = (data.data || data);
    ...
    periodCmd
        ...
        await apiGet('/api/opening-balances', { workspace_id: options.workspace }, 'Fetching opening balances...', {
            json: options.json,
            onSuccess: (data) => {
    ...
    periodCmd
        ...
        .option('--json', 'Output as JSON')
        .action(async (options) => {
        await apiPost('/api/opening-balances/batch', {
            workspace_id: options.workspace,
            period_id: options.period,
            balances: [{
