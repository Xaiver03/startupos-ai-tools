...
export function createAIBookkeepingCommand() {
    ...
    aiCmd
        ...
        try {
            ...
            if (options.conversation)
                body.conversation_id = options.conversation;
            ...
            console.log(`${chalk.bold('Description:')} ${result.description || options.text}`);
            console.log(`${chalk.bold('Confidence:')} ${result.confidence || '-'}`);
            const entry = result.suggested_entry;
            if (entry) {
    ...
    aiCmd
        ...
        try {
            ...
            console.log(chalk.bold('\nOCR Result:'));
            console.log(chalk.gray('─'.repeat(60)));
            console.log(`${chalk.bold('Document Type:')} ${result.document_type || '-'}`);
            console.log(`${chalk.bold('Confidence:')} ${result.confidence || '-'}`);
