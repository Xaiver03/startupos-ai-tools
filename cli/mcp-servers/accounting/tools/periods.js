export function createAccountingPeriodTools(client) {
    return {
        list_accounting_periods: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch(`/api/accounting-periods?${params.toString()}`);
        ...
        create_accounting_period: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/accounting-periods', {
                    method: 'POST',
        ...
        close_period: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/period-end/close', {
                    method: 'POST',
                    body: JSON.stringify(body),
                });
                return {
        ...
        get_opening_balances: {
            ...
            handler: async () => {
                const params = new URLSearchParams();
                params.append('workspace_id', client.getWorkspaceId());
                const data = await client.apiFetch(`/api/opening-balances?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
        set_opening_balance: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/opening-balances', {
                    method: 'POST',
                    body: JSON.stringify(body),
                });
                return {
