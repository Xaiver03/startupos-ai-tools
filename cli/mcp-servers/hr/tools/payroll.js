export function createPayrollTools(client) {
    return {
        list_payroll_records: {
            ...
            handler: async (args) => {
                ...
                if (args.period)
                    params.append('period', args.period);
                if (args.status)
                    params.append('status', args.status);
                const data = await client.apiFetch(`/api/payroll-records?${params.toString()}`);
        ...
        create_payroll_record: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/payroll-records', {
                    method: 'POST',
        ...
        post_payroll: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/payroll-records/post', {
                    method: 'POST',
                    body: JSON.stringify(body),
                });
                return {
