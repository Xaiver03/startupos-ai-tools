export function createReportTools(client) {
    return {
        generate_trial_balance: {
            ...
            handler: async (args) => {
                ...
                if (args.period_id)
                    params.append('period_id', args.period_id);
                const data = await client.apiFetch(`/api/reports/trial-balance?${params.toString()}`);
        ...
        generate_income_statement: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch(`/api/reports/income-statement?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
        generate_cash_journal: {
            ...
            handler: async (args) => {
                ...
                if (args.end_date)
                    params.append('end_date', args.end_date);
                const data = await client.apiFetch(`/api/reports/cash-journal?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
        generate_bank_journal: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch(`/api/reports/bank-journal?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
        get_general_ledger: {
            ...
            handler: async (args) => {
                ...
                params.append('workspace_id', client.getWorkspaceId());
                if (args.account_id)
                    params.append('account_id', args.account_id);
                if (args.start_date)
                    params.append('start_date', args.start_date);
                if (args.end_date)
                    params.append('end_date', args.end_date);
                const data = await client.apiFetch(`/api/reports/general-ledger?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
        get_account_balances: {
            ...
            handler: async (args) => {
                ...
                if (args.period_id)
                    params.append('period_id', args.period_id);
                const data = await client.apiFetch(`/api/reports/account-balances?${params.toString()}`);
                return { content: [{ type: 'text', text: JSON.stringify(data, null, 2) }] };
            },
        },
    };
