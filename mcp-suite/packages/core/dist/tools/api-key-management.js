export function createApiKeyManagementTools(client) {
    return {
        create_api_key: {
            ...
            handler: async (args) => {
                ...
                const data = await client.apiFetch('/api/api-keys', {
                    method: 'POST',
        ...
        revoke_api_key: {
            ...
            handler: async (args) => {
                const data = await client.apiFetch(`/api/api-keys/${args.key_id}`, {
                    method: 'DELETE',
                });
                return {
                    content: [{
        ...
        toggle_api_key: {
            ...
            handler: async (args) => {
                const data = await client.apiFetch(`/api/api-keys/${args.key_id}/toggle`, {
                    method: 'PATCH',
