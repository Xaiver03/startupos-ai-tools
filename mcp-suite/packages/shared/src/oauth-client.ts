...
export class OAuthClient {
   ...
   */
  async authenticate(): Promise<{ accessToken: string; refreshToken: string; userId: string; email: string }> {
  ...
  private startCallbackServer(expectedState: string, codeChallenge: string): Promise<string> {
