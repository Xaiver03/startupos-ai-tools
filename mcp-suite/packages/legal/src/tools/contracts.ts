import type { APIResponse, CreateContractInput, GenerateContractInput, GetContractInput, ListContractsInput, SSOSClient, UpdateContractInput } from '@ssos/mcp-shared';
